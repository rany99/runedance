...
import (
	...
	"runedance/kitexGen/kitex_gen/userproto/userservice"
...
func CreateUser(ctx context.Context, req *userproto.CreateUserReq) (int64, error) {
	...
	if resp.BaseResp.StatusCode != 0 {
		return 0, errStatu.New(resp.BaseResp.StatusCode, resp.BaseResp.StatusMsg)
	}
...
func GetUser(ctx context.Context, req *userproto.GetUserReq) (*userproto.UserInfo, error) {
	...
	if resp.BaseResp.StatusCode != 0 {
		return nil, errStatu.New(resp.BaseResp.StatusCode, resp.BaseResp.StatusMsg)
	}
...
func FollowUser(ctx context.Context, req *userproto.FollowUserReq) error {
	...
	if resp.BaseResp.StatusCode != 0 {
		return errStatu.New(resp.BaseResp.StatusCode, resp.BaseResp.StatusMsg)
	}
	return nil
}
