...
func (i *UserAppService) GetUser(ctx context.Context, appUserID int64, userId int64) (user *pojo.User, err error) {
...
func (i *UserAppService) GetFollowList(ctx context.Context, appUserID int64, userId int64) (userList []*pojo.User, err error) {
...
func (i *UserAppService) GetFanList(ctx context.Context, appUserID int64, userId int64) (userList []*pojo.User, err error) {
...
func (i *UserAppService) GetFriendList(ctx context.Context, appUserID int64, userId int64) (userList []*pojo.User, err error) {
...
func toUserDTO(user *userproto.UserInfo) *pojo.User {
	if user == nil {
		return nil
	}
	return &pojo.User{
...
func toUserDTOs(users []*userproto.UserInfo) []*pojo.User {
	us := make([]*pojo.User, 0, len(users))
