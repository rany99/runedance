...
func GetUserByName(ctx context.Context, userName string) (*entity.User, error) {
...
func GetFriendList(ctx context.Context, userId int64) ([]int64, error) {
	var follows []*entity.Relation
	var friend []*entity.Relation
	var friends []*entity.Relation
